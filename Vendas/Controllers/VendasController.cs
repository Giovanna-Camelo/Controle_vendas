...
namespace Controle_Vendas.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaId,funcionariosID,Tipo,Quantidade,Valor")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendaId,funcionariosID,Tipo,Quantidade,Valor")] Venda venda)
        {
            if (id != venda.VendaId)
            {
                return NotFound();
